  ...
  return (
    <div className="mt-7 space-y-5">
      ...
      <div className="grid grid-cols-1 gap-5 xl:grid-cols-[1.35fr_0.85fr]">
        <DashCard className="p-5">
          <DashCardHeader className="mb-5">
            <DashCardTitle>Predictive Performance Trends</DashCardTitle>
            <DashBadge tone="blue">Interactive</DashBadge>
          </DashCardHeader>
        ...
        <DashCard className="p-5">
          <DashCardHeader className="mb-5">
            <DashCardTitle>Failure Trend</DashCardTitle>
            <DashBadge tone="red">Live</DashBadge>
          </DashCardHeader>
          <div className="h-[360px]">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="grid grid-cols-1 gap-5 xl:grid-cols-[0.85fr_1.15fr]">
        <DashCard className="p-5">
          <DashCardHeader className="mb-5">
            <DashCardTitle>RUL Forecast Area</DashCardTitle>
            <DashBadge tone="green">Daily</DashBadge>
          </DashCardHeader>
        ...
        <DashCard className="p-5">
          <DashCardHeader className="mb-5">
            <DashCardTitle>AI Signal Contribution</DashCardTitle>
            <DashBadge tone="blue">Model</DashBadge>
          </DashCardHeader>
